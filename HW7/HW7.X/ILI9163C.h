...
void drawChar(unsigned short x, unsigned short y, char c, unsigned short color); //draws char, added
void drawString(unsigned short x, unsigned short y, char *message, unsigned short color); //draws string, added
void drawBar(unsigned short x, unsigned short y, unsigned short length, unsigned short color); //draws horizontal bar, added
