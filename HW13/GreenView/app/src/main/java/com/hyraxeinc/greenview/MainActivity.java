package com.hyraxeinc.greenview;
...
//                int startY = 200; // which row in the bitmap to analyze to read
                ...
                // update the row
                bmp.setPixels(pixels, 0, bmp.getWidth(), 0, kk, bmp.getWidth(), 1);
            }
        }
