package com.hyraxeinc.imageprocessing;
...
import com.hyraxeinc.greenview.R;
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                if ((((green(pixels[i]) - red(pixels[i])) < thresh) && ((green(pixels[i]) - blue(pixels[i])) < thresh)) && ((blue(pixels[i]) - red(pixels[i])) < thresh)) {
